...
public final class QuillMedium implements ChatFontProfile {
	private static final int LINE_HEIGHT_ADJUSTMENT = 10;
	private static final int ROW_Y_OFFSET = 0;

	private static final int PRIVATE_CHAT_GAP = 0;

	private static final int CHANNEL_NAME_Y_OFFSET = -1;
	private static final int CHANNEL_RANK_ICON_Y_OFFSET = 3;
	private static final int CHANNEL_ACCOUNT_BUILD_ICON_SPACING = 0;
	private static final int CHANNEL_USERNAME_Y_OFFSET = -1;
	private static final int CHANNEL_TEXT_Y_OFFSET = -1;
	...
	private static final int RANK_ICON_SIZE_ADJUSTMENT = 3;

	private static final int ACCOUNT_BUILD_ICON_PADDING = 0;

	@Override
	public ChatFont getChatFont() {
		return ChatFont.QUILL_MEDIUM;
	}
