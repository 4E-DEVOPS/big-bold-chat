...
public final class Barbarian implements ChatFontProfile
{
    private static final int LINE_HEIGHT_ADJUSTMENT = 4;
    private static final int ROW_Y_OFFSET = -8;

    private static final int PRIVATE_CHAT_GAP = 18;

    private static final int CHANNEL_NAME_Y_OFFSET = 0;
    private static final int CHANNEL_RANK_ICON_Y_OFFSET = 10;
    ...
    private static final int RANK_ICON_SIZE_ADJUSTMENT = 2;
